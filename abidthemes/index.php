 ...
 <!-- topbar part start here -->
    ...
    <section class="cont">
        <div class="row logo_main">
            ...
            <?php the_custom_logo(); ?>
                <!-- <a href="#"><img src="<?= get_template_directory_uri()?>/assets/images/logo/logo_bn.png" alt=""></a> -->
            </div>
            ...
            <div class="col-lg-8 ">
                <div class="banner">
                     ...
                     <a href="#">
                        ...
                        <!-- <img class="w-100" src="<?=get_template_directory_uri()?>/assets/images/banner/padmabanner.jpg" alt=""> -->
                    </a>
                </div>
            <!-- slider part start -->
                <div class="slider">
